...
import in.edu.ssn.testssnapp.fragments.BusAlertsFragment;
import in.edu.ssn.testssnapp.fragments.ClubFragment;
import in.edu.ssn.testssnapp.fragments.EventFragment;
import in.edu.ssn.testssnapp.fragments.ExamCellFragment;
import in.edu.ssn.testssnapp.fragments.PlacementFragment;
import in.edu.ssn.testssnapp.fragments.StudentFeedFragment;
import in.edu.ssn.testssnapp.message_utils.NewMessageEvent;
...
public class StudentHomeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*try {
            FileInputStream inputStream = openFileInput("bus_data_finalized.json");
        } catch (Exception e) {
            e.printStackTrace();
