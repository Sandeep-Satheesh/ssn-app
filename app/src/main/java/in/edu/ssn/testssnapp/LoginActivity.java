...
import in.edu.ssn.testssnapp.models.Faculty;
import in.edu.ssn.testssnapp.models.Volunteers;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    LinearLayout layout_mode_of_study;
    int clearance;
    Boolean flag = true;
    ...
    public void signInUgStudent(FirebaseUser user) {
        ...
        String dept = flag2;
        isDayScholar = IsDayscholar(flag3);
        ...
        SharedPref.putBoolean(getApplicationContext(), "isDayScholar", isDayScholar);
        SharedPref.putInt(getApplicationContext(), "year", year);
        SharedPref.putInt(getApplicationContext(), "dont_delete", "is_logged_in", 2);
        SharedPref.putString(getApplicationContext(), "userType", "UGUser");
    ...
    private boolean IsDayscholar(String flag3) {
        return flag3.equals("ds");
    }
    ...
    public void signInPgStudent(FirebaseUser user) {
        ...
        SharedPref.putBoolean(getApplicationContext(), "isDayScholar", isDayScholar);
        SharedPref.putInt(getApplicationContext(), "dont_delete", "is_logged_in", 2);
        SharedPref.putString(getApplicationContext(), "userType", "PGUser");
    ...
    public void signInAlumni(FirebaseUser user) {
        ...
        SharedPref.putString(getApplicationContext(), "name", name);
        SharedPref.putInt(getApplicationContext(), "dont_delete", "is_logged_in", 2);
        SharedPref.putString(getApplicationContext(), "userType", "AlumnusUser");
        FCMHelper.SubscribeToTopic(this, Constants.Event);
        FCMHelper.SubscribeToTopic(this, Constants.GLOBAL_CHAT);
    ...
    public void signInFaculty(FirebaseUser user) {
        ...
        SharedPref.putString(getApplicationContext(), "name", name);
        SharedPref.putInt(getApplicationContext(), "dont_delete", "is_logged_in", 2);
        SharedPref.putString(getApplicationContext(), "userType", "FacultyUser");
    ...
    public void promptDetailsDialog(final FirebaseUser user) {
        ...
        TextView ds = dialogView.findViewById(R.id.ds);
        ds.setOnClickListener(this);
        TextView hs = dialogView.findViewById(R.id.hs);
        ...
        layout_mode_of_study = dialogView.findViewById(R.id.mode_of_study);
        ...
        okTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (flag0) {
                    case "ug":
                        if (flag3.equals("")) {
                            Toast toast = Toast.makeText(LoginActivity.this, "Please choose your mode of study", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.CENTER, 0, 0);
                            toast.show();
                    ...
                    for (String id : cids) {
                        ...
                        if (identifier != v.getId())
                            ...
                            if (flag0.equals("ug")) {
                                ...
                                layout_mode_of_study.setVisibility(View.VISIBLE);
                            }
                            else if (flag0.equals("pg")) {
                                layout_mode_of_study.setVisibility(View.VISIBLE);
                                layout_year_dept.setVisibility(View.GONE);
                            } else {
                                layout_year_dept.setVisibility(View.GONE);
                                layout_mode_of_study.setVisibility(View.GONE);
                            }
                        }
                    }
                    break;
        ...
        protected Void doInBackground(Void... voids) {
            Glide.with(LoginActivity.this).asFile().load("https://docs.google.com/spreadsheets/u/0/d/1kcPtObp_2M2dQOxnR1of9zl7zeLPxWz-ZDpatO-YKq4/export?format=csv&id=1kcPtObp_2M2dQOxnR1of9zl7zeLPxWz-ZDpatO-YKq4&gid=0").signature(new ObjectKey(System.currentTimeMillis())).into(new SimpleTarget<File>() {
                ...
                public void onResourceReady(@NonNull File resource, @Nullable Transition<? super File> transition) {
                    ...
                    File file = new File(dir, "data_student.csv");
                    try {
                        FileInputStream inStream = new FileInputStream(resource);
                        FileOutputStream outStream = new FileOutputStream(file);
                        FileChannel inChannel = inStream.getChannel();
                        ...
                        if (file.exists()) {
                            try {
                                CsvHolder<Volunteers> holder = ObjectCsv.getInstance().from(file.getPath()).with(CsvDelimiter.COMMA).getCsvHolderforClass(Volunteers.class);
                                List<Volunteers> models = holder.getCsvRecords();
