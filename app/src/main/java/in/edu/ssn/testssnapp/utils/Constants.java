...
public class Constants {
    ...
    public static final String BUS_TRACKING_NOTIFS_CHANNELID = "2";
    ...
    //Bus-tracking related constants.
    public static final int MIN_REQD_CONCURRENT_LOCATIONS = 1; //TODO: change to higher no. when releasing.
}